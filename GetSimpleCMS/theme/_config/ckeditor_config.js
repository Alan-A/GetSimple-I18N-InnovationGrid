...
//config.entities                    = false;      // use HTML entities in the editor output (default)
	config.entities                    = true;       // use HTML entities in the editor output

	config.allowedContent              = true;       // disable acf
	config.extraAllowedContent = '&shy;';
	...
	config.toolbar_advanced = 
		...
		'/',
		['Styles','Format','Font','FontSize','nbsp','Timestamp','CodeSnippet']];
...
//	extraPlugins.push('entities');            // official plugin, escapes HTML entities in editor output
	extraPlugins.push('nbsp');                // inserts '&nbsp;', toolbar id 'nbsp'
	extraPlugins.push('timestamp');           // inserts text & timestamp, toolbar id 'CodeSnippet'
