<?php
/**
 * British English Language File v3.3
 *
 * Date:			6 December 2011
 * Revision:		Feb 2014
 * Version:			GetSimple 3.3.1
 * Translators:     N J Wastell, 2013-06-20
 *
 * @package GetSimple
 * @subpackage Language
 */
...
"NO_MENU_PAGES" 		=> 	"No pages are set to appear in the main menu",
...
"DATE_AND_TIME_FORMAT"	=>	"d F Y, H:i", //date and time
